const projects = [
    ...
    {
        title: 'Spam Detector',
        description: 'A machine learning tool for filtering spam emails using a unigram model. This model is fine-tuned to detect spam emails with 94% accuracy.',
        sampleImage: '1SpamDetector.png',
        githubUrl: 'https://github.com/OntarioTech-CS-program/w24-csci2020u-assignment01-aguiar',
        skills: ['Java', 'Maven', 'Glassfish']
    },
    {
        title: 'Personal Portfolio Site',
        description: 'A personal portfolio site that showcases my projects, skills, and experiences. This site is built using React and Tailwind CSS.',
        sampleImage: '1PortfolioSite.png',
        githubUrl: 'https://github.com/yambrose/portfolio_site',
